                ...
                <div class="row">
                    <div class="well col-md-5 center login-box">
                        <div class="alert alert-info">                          
                            <h4>   La nueva contraseña deve cumplir con:</h4>
                            <h5>   -Tener Una Letra Mayúscula</h5>
                            <h5>   -La clave debe tener al menos 6 caracteres</h5>
                            <h5>   -La clave debe tener menos de 16 caracteres</h5>
                            <h5>    -La clave debe tener al menos una letra minúscula</h5>
                            <h5>    -La clave debe tener al menos un caracter numérico</h5>
                        </div>
                        <h3><?php echo $error ?></h3>

                        <form class="form-horizontal" action="<?php echo base_url() ?>index.php/Welcome/cambiarContrasena" method="post">
                            <fieldset>
                                ...
                                <h4>Antigua Contrase&nacute;a </h4>
                                <div class="input-group input-group-lg">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-lock red"></i></span>
                                    <input name="contrasena" id="contrasena" type="password" class="form-control" placeholder="Contraseña">
                                </div>
                                <h4>Nueva Contrase&nacute;a </h4>
                                <div class="input-group input-group-lg">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-lock red"></i></span>
                                    <input name="nuevacontrasena" id="nuevacontrasena" type="password" class="form-control" placeholder="Nueva Contraseña">
                                </div>
                                <h4>Repetir la Nueva Contrase&nacute;a </h4>
                                <div class="input-group input-group-lg">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-lock red"></i></span>
                                    <input name="nueva2contrasena" id="nueva2contrasena" type="password" class="form-control" placeholder="Nueva Contraseña">
                                </div>
                                ...
                                <p class="center col-md-5">
                                    ...
                                    <a class="btn btn-primary" href="<?php echo base_url() ?>index.php/Welcome/login" > Regresar</a>
                                </p>
                            </fieldset>
                        </form>
                    </div>
