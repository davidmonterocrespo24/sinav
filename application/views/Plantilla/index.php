...
function updateiCheckSkinandStyle()
{
    ...
    $('input.icheck-2').iCheck({
        ...
        <link rel="stylesheet" href="<?php echo base_url() ?>/neon/assets/js/select2/select2-bootstrap.css">
        <link rel="stylesheet" href="<?php echo base_url() ?>/neon/assets/js/select2/select2.css">
        <link rel="stylesheet" href="<?php echo base_url() ?>/neon/assets/js/selectboxit/jquery.selectBoxIt.css">
        <link rel="stylesheet" href="<?php echo base_url() ?>/neon/assets/js/daterangepicker/daterangepicker-bs3.css">
        <link rel="stylesheet" href="<?php echo base_url() ?>/neon/assets/js/icheck/skins/minimal/_all.css">
        <link rel="stylesheet" href="<?php echo base_url() ?>/neon/assets/js/icheck/skins/square/_all.css">
        <link rel="stylesheet" href="<?php echo base_url() ?>/neon/assets/js/icheck/skins/flat/_all.css">
        <link rel="stylesheet" href="<?php echo base_url() ?>/neon/assets/js/icheck/skins/futurico/futurico.css">
        <link rel="stylesheet" href="<?php echo base_url() ?>/neon/assets/js/icheck/skins/polaris/polaris.css">
        <!-- Bottom Scripts -->
        <script src="<?php echo base_url() ?>/neon/assets/js/gsap/main-gsap.js"></script>
        <script src="<?php echo base_url() ?>/neon/assets/js/jquery-ui/js/jquery-ui-1.10.3.minimal.min.js"></script>
        <script src="<?php echo base_url() ?>/neon/assets/js/bootstrap.js"></script>
        <script src="<?php echo base_url() ?>/neon/assets/js/joinable.js"></script>
        <script src="<?php echo base_url() ?>/neon/assets/js/resizeable.js"></script>
        <script src="<?php echo base_url() ?>/neon/assets/js/neon-api.js"></script>
        <script src="<?php echo base_url() ?>/neon/assets/js/select2/select2.min.js"></script>
        <script src="<?php echo base_url() ?>/neon/assets/js/bootstrap-tagsinput.min.js"></script>
        <script src="<?php echo base_url() ?>/neon/assets/js/typeahead.min.js"></script>
        <script src="<?php echo base_url() ?>/neon/assets/js/selectboxit/jquery.selectBoxIt.min.js"></script>
        <script src="<?php echo base_url() ?>/neon/assets/js/bootstrap-datepicker.js"></script>
        <script src="<?php echo base_url() ?>/neon/assets/js/bootstrap-timepicker.min.js"></script>
        <script src="<?php echo base_url() ?>/neon/assets/js/bootstrap-colorpicker.min.js"></script>
        ...
        <script src="<?php echo base_url() ?>/neon/assets/js/jquery.multi-select.js"></script>
        <script src="<?php echo base_url() ?>/neon/assets/js/icheck/icheck.min.js"></script>
        <script src="<?php echo base_url() ?>/neon/assets/js/neon-chat.js"></script>
        <script src="<?php echo base_url() ?>/neon/assets/js/neon-custom.js"></script>
        <script src="<?php echo base_url() ?>/neon/assets/js/neon-demo.js"></script>
