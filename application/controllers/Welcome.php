...
//                    if ($newdata['tipousuario'] == 'Administrador') {
//                    //    redirect("Usuario/consumoUsuarioAdmin");
//                    }
echo $nombre;
...
//                        'tipousuario' => $this->tipoDeUsuario($conectado_LDAP, $userdn, $ldap_dn),
//                        'logged_in' => TRUE
//                    );
